...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        context.register(PANDORITH_SPIRE_NBT_PLACED_KEY, new PlacedFeature(configuredFeatures.getOrThrow(ModConfiguredFeatures.PANDORITH_SPIRE_NBT_KEY), modifiers));
    }
